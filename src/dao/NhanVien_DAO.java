	...
	public NhanVien getNhanVienTheoID(String id) {
		...
		try {
			...
			while(rs.next()) {
				...
				nhanVien = new NhanVien(idNhanVien, hoTen, phai, ngaySinh, ngayBatDauCongTac, ngayKetThucCongTac, email, soDienThoai, chucVu, taiKhoan, phongBan, phuCap, anhDaiDien);
			}
