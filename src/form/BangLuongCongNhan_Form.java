...
public class BangLuongCongNhan_Form extends JPanel implements ActionListener, MouseListener {
	private int width = 1250;
	private int height = 725;
	private BangLuongCongNhan_BUS bl_bus;
	private BangChamCongCongNhan_BUS cccn_bus;
	...
	public BangLuongCongNhan_Form(int width, int height) {
		setBackground(new Color(240, 240, 240));
		bl_bus = new BangLuongCongNhan_BUS();
		cccn_bus = new BangChamCongCongNhan_BUS();
...
//		tableLuong.getColumnModel().getColumn(11).setPreferredWidth(80);
	...
	public static void main(String[] args) {
		new BangLuongCongNhan_Form(WIDTH, HEIGHT).setVisible(true);
	}
