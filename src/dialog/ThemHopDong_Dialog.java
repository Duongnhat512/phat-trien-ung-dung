...
public class ThemHopDong_Dialog extends JDialog implements ActionListener {
	...
	public void initComponents() {
		...
		tableCTHopDong.setModel(new DefaultTableModel(new Object[][] {},
				new String[] { "ID S\u1EA3n ph\u1EA9m", "T\u00EAn s\u1EA3n ph\u1EA9m", "S\u1ED1 l\u01B0\u1EE3ng",
						"\u0110\u01A1n gi\u00E1", "Th\u00E0nh ti\u1EC1n" }));
		...
		gl_panelSanPham.setHorizontalGroup(gl_panelSanPham.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelSanPham.createSequentialGroup().addGap(10)
						...
						.addGap(65).addComponent(lblChtLiu, GroupLayout.PREFERRED_SIZE, 130, GroupLayout.PREFERRED_SIZE)
						.addGap(39)
				...
				.addGroup(gl_panelSanPham.createSequentialGroup().addGap(10)
						...
						.addGap(39).addComponent(txtTenSP, GroupLayout.PREFERRED_SIZE, 209, GroupLayout.PREFERRED_SIZE)
						.addGap(65).addComponent(lblnVTnh, GroupLayout.PREFERRED_SIZE, 130, GroupLayout.PREFERRED_SIZE)
						.addGap(39)
						.addComponent(txtDonViTinh, GroupLayout.PREFERRED_SIZE, 209, GroupLayout.PREFERRED_SIZE))
				.addGroup(gl_panelSanPham.createSequentialGroup().addGap(10)
						.addComponent(lblnGi, GroupLayout.PREFERRED_SIZE, 130, GroupLayout.PREFERRED_SIZE).addGap(39)
						.addComponent(txtDonGia, GroupLayout.PREFERRED_SIZE, 209, GroupLayout.PREFERRED_SIZE).addGap(65)
						.addComponent(lblSLngt, GroupLayout.PREFERRED_SIZE, 130, GroupLayout.PREFERRED_SIZE).addGap(39)
						.addComponent(txtSoLuong, GroupLayout.PREFERRED_SIZE, 209, GroupLayout.PREFERRED_SIZE))
				.addGroup(gl_panelSanPham.createSequentialGroup().addGap(453).addComponent(lblThongBaoSP,
						GroupLayout.PREFERRED_SIZE, 378, GroupLayout.PREFERRED_SIZE)));
		gl_panelSanPham.setVerticalGroup(gl_panelSanPham.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelSanPham.createSequentialGroup().addGap(10)
						.addGroup(gl_panelSanPham.createParallelGroup(Alignment.LEADING).addComponent(lblIdSnPhm)
								.addComponent(txtIDSanPham, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(lblChtLiu).addComponent(txtChatLieu, GroupLayout.PREFERRED_SIZE,
										GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
						.addGap(20)
						.addGroup(gl_panelSanPham.createParallelGroup(Alignment.LEADING).addComponent(lblTnSnPhm)
								.addComponent(txtTenSP, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(lblnVTnh).addComponent(txtDonViTinh, GroupLayout.PREFERRED_SIZE,
										GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
						.addGap(24)
						.addGroup(gl_panelSanPham.createParallelGroup(Alignment.LEADING).addComponent(lblnGi)
								.addComponent(txtDonGia, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(lblSLngt).addComponent(txtSoLuong, GroupLayout.PREFERRED_SIZE,
										GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
						.addGap(9)
...
//		 Hiển thị IDHopDong
	...
	private void themHopDong() {
		...
		if (kiemTraDuLieuHopDong()) {
			...
			HopDongSanPham hd = new HopDongSanPham(idHopDong, tenHopDong, ngayBatDau, ngayKetThuc, nv, tongTien,
					ghiChu);
	...
	private void docDuLieuLenBangCTHD() {
		...
		for (ChiTietHopDong chiTietHopDong : listCTHD) {
			dm.addRow(new Object[] { chiTietHopDong.getSanPham().getIdSanPham(),
					chiTietHopDong.getSanPham().getTenSanPham(), chiTietHopDong.getSoLuong(),
					chiTietHopDong.getSanPham().getDonGia(),
	...
	private void boChonSanPham() {
		...
		if (JOptionPane.showConfirmDialog(this, "Bạn có muốn bỏ chọn sản phẩm này không?", "Hỏi nhắc!",
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (o.equals(btnHuy)) {
			if ((JOptionPane.showConfirmDialog(this, "Bạn có muốn hủy không?", "Hỏi nhắc!",
					JOptionPane.YES_NO_OPTION)) == JOptionPane.YES_OPTION) {
				this.dispose();
			}
		}
